...
public class NormalTerrainGenerator {
    ...
    public void setup(World world, Random rand) {
        ...
        net.minecraftforge.event.terraingen.InitNoiseGensEvent.ContextOverworld ctx = new net.minecraftforge.event.terraingen.InitNoiseGensEvent.ContextOverworld(
                this.minLimitPerlinNoise, this.maxLimitPerlinNoise, this.mainPerlinNoise, this.surfaceNoise, noiseGen5,
                this.depthNoise, mobSpawnerNoise);
    ...
    public void replaceBiomeBlocks(int x, int z, ChunkPrimer primer, IChunkGenerator generator, Biome[] biomes) {
        // if
        // (!net.minecraftforge.event.ForgeEventFactory.onReplaceBiomeBlocks(generator,
        // x, z, primer, this.world)) return;
        ...
        for(int i = 0; i < 16; ++i) {
            for(int j = 0; j < 16; ++j) {
                ...
                biome.genTerrainBlocks(this.world, this.random, primer, x * 16 + i, z * 16 + j,
