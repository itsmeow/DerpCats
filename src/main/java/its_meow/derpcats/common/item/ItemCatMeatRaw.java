...
public class ItemCatMeatRaw extends ItemFood {
    ...
    public ItemCatMeatRaw(int amount, boolean isWolfFood) {
        super(amount, isWolfFood);
        this.setCreativeTab(DerpCatsMod.tab_derpcats);
        this.setRegistryName("catmeatraw");
        this.setUnlocalizedName("catmeatraw");
