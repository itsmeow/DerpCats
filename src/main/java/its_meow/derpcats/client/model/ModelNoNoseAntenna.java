...
//Models are very unexplainable. This model was made in Techne. Please consider using it to make models, however corrections are needed and animations must be written out. Sorry.
public class ModelNoNoseAntenna extends ModelBase {
    // fields
    ...
    public ModelNoNoseAntenna() {
        ...
        this.Ear1.addBox(0F, 0F, 0F, 1, 4, 1);
        this.Ear1.setRotationPoint(-5F, -10F, -21F);
        this.Ear1.setTextureSize(128, 128);
        this.Ear1.mirror = true;
        setRotation(this.Ear1, 0F, 0F, 0F);
        this.Ear2 = new ModelRenderer(this, 85, 0);
        this.Ear2.addBox(0F, 0F, 0F, 1, 4, 1);
        this.Ear2.setRotationPoint(2F, -10F, -21F);
