...
public class ModelCrazyCat extends ModelBase {
    // fields
    ...
    public ModelCrazyCat() {
        ...
        setRotation(this.Tail2, 50F, 0F, 0F);

        // To center Z rotation:
        // Add negative offset of half of the box size in XYZ
        // Add positive of negative offset to position
        // Rotate!
    }
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        if(entity instanceof EntityCrazyCat) {
            this.setRotationAngles(f, f1, f2, f3, f4, f5, (EntityCrazyCat) entity);
        }
    }

    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, EntityCrazyCat entity) {
        ...
        this.Tail2.rotateAngleZ = entity.headRoll;
        this.BackLeftLeg.rotateAngleZ = -entity.legRoll;
        this.FrontLeftLeg.rotateAngleZ = -entity.legRoll;
        this.BackRightLeg.rotateAngleZ = entity.legRoll;
        this.FrontRightLeg.rotateAngleZ = entity.legRoll;
    }
