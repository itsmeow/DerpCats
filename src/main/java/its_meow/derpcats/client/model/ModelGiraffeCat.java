...
public class ModelGiraffeCat extends ModelBase {
    // fields
    ...
    ModelRenderer NeckLong;

    public ModelGiraffeCat() {
        ...
        this.Ear1.setRotationPoint(-5F, -37F, -24F);
        ...
        this.Ear2.setRotationPoint(2F, -37F, -24F);
        ...
        this.NeckLong = new ModelRenderer(this, 47, 84);
        this.NeckLong.addBox(0F, 0F, 0F, 8, 35, 7);
        this.NeckLong.setRotationPoint(-4F, -30F, -28F);
        this.NeckLong.setTextureSize(128, 128);
        this.NeckLong.mirror = true;
        setRotation(this.NeckLong, 0.3717861F, 0F, 0F);
    }
